 ...
 * {@link CacheDisp atcher})添加Request<br>
 * 2、另一边由TaskThread不停从NetworkQueue中取Request并交给Network执行器(逻辑请查看
 * {@link org.kymjs.kjframe.http.NetworkDispatcher} )，<br>
 * 3、Network执行器将执行成功的NetworkResponse返回给TaskThead，并通过Request的定制方法
 * {@link org.kymjs.kjframe.http.Request#parseNetworkResponse()}封装成Response，最终交给分发器 {@link org.kymjs.kjframe.http.Delivery}
